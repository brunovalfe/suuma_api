...
<head>
    ...
    <link href="{{ asset('dist/js/app.4719dc7e.js') }}" rel=preload as=script>
...
<body><noscript><strong>We're sorry but suuma doesn't work properly without JavaScript enabled. Please enable it to
    ...
    <div id=app></div>
    <script src="{{ asset('dist/js/chunk-vendors.6ed8b563.js') }}"> </script> <script src="{{ asset('dist/js/app.4719dc7e.js') }}"> </script> </body> </html>
