...
<head>
    ...
    <link href="{{ asset('dist/css/app.456a39ac.css') }}" rel=preload as=style>
    <link href="{{ asset('dist/css/chunk-vendors.89cf2add.css') }}" rel=preload as=style>
    <link href="{{ asset('dist/js/app.9318107f.js') }}" rel=preload as=script>
    ...
    <link href="{{ asset('dist/css/app.456a39ac.css') }}" rel=stylesheet>
</head>

<body><noscript><strong>We're sorry but suuma doesn't work properly without JavaScript enabled. Please enable it to
        continue.</strong></noscript>
<div id=app></div>
<script src="{{ asset('dist/js/chunk-vendors.98786b3d.js') }}"> </script> <script src="{{ asset('dist/js/app.9318107f.js') }}"> </script> </body> </html>
