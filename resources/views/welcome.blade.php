...
<head>
    ...
    <link href="{{ asset('dist/js/app.8a92332d.js') }}" rel=preload as=script>
...
<div id=app></div>
<script src="{{ asset('dist/js/chunk-vendors.98786b3d.js') }}"> </script> <script src="{{ asset('dist/js/app.8a92332d.js') }}"> </script> </body> </html>
