...
<head>
    ...
    <link href="{{ asset('dist/js/app.9924d782.js') }}" rel=preload as=script>
...
<div id=app></div>
<script src="{{ asset('dist/js/chunk-vendors.98786b3d.js') }}"> </script> <script src="{{ asset('dist/js/app.9924d782.js') }}"> </script> </body> </html>
